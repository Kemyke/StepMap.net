...
ALTER TABLE [stepmap].[Project]  WITH CHECK ADD  CONSTRAINT [FK_Step_Project] FOREIGN KEY([NextStepId])
REFERENCES [stepmap].[Step] ([Id])
GO

ALTER TABLE [stepmap].[Project] CHECK CONSTRAINT [FK_Step_Project]
GO
